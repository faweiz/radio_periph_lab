...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    time_spent = (float)total_time/(125*1000000.0);
	
	throughput = bytes_transferred / time_spent; //bytes/sec
	throughput = throughput / 1000000; //Mbytes/sec
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Fawei Zhang - Custom Peripheral Demonstration\n\r");
